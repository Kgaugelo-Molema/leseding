...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/lesedin1/domains/lesedingconsulting.co.za/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats",
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/lesedin1/domains/lesedingconsulting.co.za/awstats/.data",
